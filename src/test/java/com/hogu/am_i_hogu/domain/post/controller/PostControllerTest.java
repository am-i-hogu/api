...
class PostControllerTest {
    ...
    void getPostDetailAsGuestReturnsPostDetail() throws Exception {
        ...
        mockMvc.perform(get("/api/posts/{postId}", postId))
                ...
                .andExpect(jsonPath("$.images[0].imageUrl").value("https://example.com/image1.jpg"))
                .andExpect(jsonPath("$.images[0].order").value(0))
                .andExpect(jsonPath("$.images[0].isThumbnail").value(true))
                .andExpect(jsonPath("$.images[1].imageUrl").value("https://example.com/image2.jpg"))
                .andExpect(jsonPath("$.images[1].order").value(1))
                .andExpect(jsonPath("$.images[1].isThumbnail").value(false))
